...
function Electronics() {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-r from-blue-50 via-white to-green-50 py-20 border-b">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <Link
                to="/shop"
                className="mt-7 inline-flex bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-xl font-semibold transition"
              >
                Shop Electronics
              </Link>
            </div>
